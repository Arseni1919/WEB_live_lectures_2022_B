...
create table try_table_1
(
    id   int auto_increment
        primary key,
    name varchar(200) null,
    constraint try_table_1_id_uindex
        unique (id)
);

INSERT INTO myflaskappdb.try_table_1 (id, name) VALUES (1, 'try_name_1');
INSERT INTO myflaskappdb.try_table_1 (id, name) VALUES (2, 'try_name_1');
